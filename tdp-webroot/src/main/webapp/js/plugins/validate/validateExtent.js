jQuery(document).ready(function () {
    ...
    jQuery.validator.addMethod("phone", function (value, el) {
        ...
        var regNeiTel = /^(\d{3,4})?$/;//固话
        return this.optional(el) || (regMobile.test(value) || regTel.test(value) || regNeiTel.test(value));
    }, "请输入有效的电话");
    //url,自带不好用，覆写
    ...
    //只能字母数字汉字
    jQuery.validator.addMethod("numchinese", function (value, element) {
        var numchinese = /^[A-Za-z0-9\u4e00-\u9fa5·]+$/;
        return this.optional(element) || (numchinese.test(value));
    }, "请输入字母数字汉字");
    //邮箱验证
